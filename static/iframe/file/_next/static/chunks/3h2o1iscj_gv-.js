(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 75497, (e, t, r) => {
    "use strict";
    ...
    function c(e) {
        return e.replace(a, e => i[e])
    }

    function s(e) {
        return e.replace(o, e => u[e])
    }
}, 68402, (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", {
    ...
    let i = e.r(81258),
        ...
        b = e => {
            ...
            i ? (b.innerHTML = i.__html || "", p()) : a ? (b.textContent = "string" == typeof a ? a : Array.isArray(a) ? a.join("") : "", p()) : t && (b.src = t, y.set(t, _)), (0, d.setAttributesFromProps)(b, e), "worker" === u && b.setAttribute("type", "text/partytown"), b.setAttribute("data-nscript", u), s && (e => {
    ...
    function m(e) {
        ...
        (0, c.useEffect)(() => {
            let e = t || r;
            I.current || (l && e && g.has(e) && l(), I.current = !0)
        }, [l, t, r]);
        let E = (0, c.useRef)(!1);
        if ((0, c.useEffect)(() => {
                if (!E.current) {
                    if ("afterInteractive" === i) b(e);
                    else "lazyOnload" === i && ("complete" === document.readyState ? (0, f.requestIdleCallback)(() => b(e)) : window.addEventListener("load", () => {
                        (0, f.requestIdleCallback)(() => b(e))
                    }));
                    E.current = !0
                }
            }, [e, i]), ("beforeInteractive" === i || "worker" === i) && (_ ? (h[i] = (h[i] || []).concat([{
                id: t,
                src: r,
                onLoad: n,
                onReady: l,
            ...
            if (d && d.forEach(e => {
                ...
                if (!r) return y.dangerouslySetInnerHTML && (y.children = y.dangerouslySetInnerHTML.__html, delete y.dangerouslySetInnerHTML), (0, u.jsx)("script", {
                    nonce: O,
            ...
            "afterInteractive" === i && r && o.default.preload(r, y.integrity ? {
                as: "script",
                integrity: y.integrity,
                nonce: O,
                crossOrigin: y.crossOrigin

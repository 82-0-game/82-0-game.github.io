(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 24688, e => {
    "use strict";
    var t, r, i = e.i(31308);
    ...
    function n(e, t, r, i) {
        let s = null == i || "number" == typeof i || "boolean" == typeof i ? i : r(i),
            n = t.get(s);
        return void 0 === n && (n = e.call(this, i), t.set(s, n)), n
    }
    ...
    var m = ((t = m || {}).MISSING_MESSAGE = "MISSING_MESSAGE", t.MISSING_FORMAT = "MISSING_FORMAT", t.ENVIRONMENT_FALLBACK = "ENVIRONMENT_FALLBACK", t.INSUFFICIENT_PATH = "INSUFFICIENT_PATH", t.INVALID_MESSAGE = "INVALID_MESSAGE", t.INVALID_KEY = "INVALID_KEY", t.FORMATTING_ERROR = "FORMATTING_ERROR", t);
    ...
    let b = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g,
        H = /[\t-\r \x85\u200E\u200F\u2028\u2029]/i,
        y = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,
        B = /^(@+)?(\+|#+)?[rs]?$/g,
        d = /(\*)(0+)|(#+)(0+)|(0+)/g,
    ...
    let w = !!Object.fromEntries,
        ...
        D = w ? Object.fromEntries : function(e) {
            let t = {};
        ...
        k = RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
    var V = class {
        constructor(e, t = {}) {
                ...
                if (35 !== e && 39 !== e && 60 !== e && 123 !== e && 125 !== e) {
                    let e = function(e) {
                        ...
                        for (let i = 0; i < e.length;) {
                            ...
                            if (10 === s) t++, r = 1, i++;
                            else if (r++, s >= 55296 && s <= 56319 && i + 1 < e.length) {
        ...
        parseMessage(e, t, r) {
            ...
            for (; !this.isEOF();) {
                ...
                if (123 === s) {
                    ...
                    if (60 === s && !this.ignoreTag && K(this.peek() || 0)) {
                ...
                else if (!r) return this.error(26, O(this.clonePosition(), this.clonePosition()));
                else break
            }
            return {
                val: i,
        ...
        parseTag(e, t) {
            ...
            if (!this.bumpIf(">")) return this.error(23, O(r, this.clonePosition())); {
                let s = this.parseMessage(e + 1, t, !0);
                if (s.err) return s;
                let n = s.val,
                    o = this.clonePosition();
                if (!this.bumpIf("</")) return this.error(27, O(r, this.clonePosition())); {
                    if (this.isEOF() || !K(this.char())) return this.error(23, O(o, this.clonePosition()));
                    let e = this.clonePosition();
                    return i !== this.parseTagName() ? this.error(26, O(e, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">")) ? {
                        val: {
                            type: 8,
                            value: i,
                            children: n,
                        ...
                        err: null
                    } : this.error(23, O(o, this.clonePosition()))
                }
            }
        }
        parseTagName() {
        ...
        parseLiteral(e, t) {
            ...
            for (;;) {
                ...
                let s = this.tryParseUnquoted(e, t);
                if (s) {
                    i += s;
                    continue
                }
                let n = this.tryParseLeftAngleBracket();
                if (n) {
                    i += n;
                    continue
                }
        ...
        tryParseLeftAngleBracket() {
            var e;
            return this.isEOF() || 60 !== this.char() || !this.ignoreTag && (K(e = this.peek() || 0) || 47 === e) ? null : (this.bump(), "<")
        }
        tryParseQuote(e) {
        ...
        parseArgument(e, t) {
            let r = this.clonePosition();
            if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(1, O(r, this.clonePosition()));
            if (125 === this.char()) return this.bump(), this.error(2, O(r, this.clonePosition()));
            let i = this.parseIdentifierIfPossible().value;
            if (!i) return this.error(3, O(r, this.clonePosition()));
            if (this.bumpSpace(), this.isEOF()) return this.error(1, O(r, this.clonePosition()));
            switch (this.char()) {
                case 125:
                    return this.bump(), {
                        val: {
                ...
                default:
                    return this.error(3, O(r, this.clonePosition()))
            }
        }
        parseIdentifierIfPossible() {
            ...
            let t = this.clonePosition(),
                r = this.offset(),
                i = (e = this.message, k.lastIndex = r, k.exec(e)[1] ?? ""),
                s = r + i.length;
        ...
        parseArgumentOptions(e, t, r, i) {
            ...
            switch (n) {
                ...
                case "time":
                    {
                        ...
                        if (this.bumpIf(",")) {
                            ...
                            if (r.err) return r;
                            let i = U(r.val);
                            if (0 === i.length) return this.error(6, O(this.clonePosition(), this.clonePosition()));
                            e = {
                                style: i,
                        ...
                        if (t.err) return t;
                        let s = O(i, this.clonePosition());
                        if (e && e.style.startsWith("::")) {
                            let t = G(e.style.slice(2));
                            if ("number" === n) {
                                ...
                                let i;
                                if (0 === t.length) return this.error(10, s);
                                let o = t;
                                return this.locale && (o = function(e, t) {
                                    ...
                                    for (let i = 0; i < e.length; i++) {
                                        ...
                                        if ("j" === s) {
                                            let n = 0;
                                            for (; i + 1 < e.length && e.charAt(i + 1) === s;) n++, i++;
                                            let o = 1 + (1 & n),
                                                h = n < 2 ? 1 : 3 + (n >> 1),
                                                a = function(e) {
                                                    let t, r = e.hourCycle;
                                                    ...
                                                    let i = e.language;
                                                    return "root" !== i && (t = e.maximize().region), (L[t || ""] || L[i || ""] || L[`${i}-001`] || L["001"])[0]
                                                }(t);
                                    ...
                                    val: {
                                        ...
                                        style: {
                                            ...
                                            parsedOptions: this.shouldParseSkeletons ? (i = {}, o.replace(b, e => {
                                                let t = e.length;
                                                switch (e[0]) {
                                                    case "G":
                ...
                case "select":
                    {
                        let s = this.clonePosition();
                        if (this.bumpSpace(), !this.bumpIf(",")) return this.error(12, O(s, { ...s
                        }));this.bumpSpace();
                        let o = this.parseIdentifierIfPossible(),
                            h = 0;
                        if ("select" !== n && "offset" === o.value) {
                        ...
                        let a = this.tryParsePluralOrSelectOptions(e, n, t, o);
                        if (a.err) return a;
                        let l = this.tryParseArgumentClose(i);
                        if (l.err) return l;
                        let u = O(i, this.clonePosition());
                        if ("select" === n) return {
                            val: {
                                type: 5,
                                value: r,
                ...
                default:
                    return this.error(5, O(s, o))
            }
        }
        tryParseArgumentClose(e) {
            return this.isEOF() || 125 !== this.char() ? this.error(1, O(e, this.clonePosition())) : (this.bump(), {
                val: !0,
                err: null
            })
        }
                ...
                case 39:
                    {
                        this.bump();
                        let e = this.clonePosition();
                        if (!this.bumpUntil("'")) return this.error(11, O(e, this.clonePosition()));this.bump();
                        break
                    }
                case 123:
                    e += 1, this.bump();
        ...
        parseNumberSkeletonFromString(e, t) {
            ...
            try {
                r = function(e) {
                    ...
                    let t = e.split(H).filter(e => e.length > 0),
                        r = [];
                    for (let e of t) {
                        let t = e.split("/");
                        ...
                        for (let r of e) {
                            switch (r.stem) {
                                ...
                                case "integer-width":
                                    ...
                                    r.options[0].replace(d, function(e, r, i, s, n, o) {
                                        if (r) t.minimumIntegerDigits = i.length;
                                        else if (s && n) throw Error("We currently do not support maximum integer digits");
                            ...
                            if (y.test(r.stem)) {
                                ...
                                r.stem.replace(y, function(e, r, i, s, n, o) {
                            ...
                            let i = function(e) {
                                ...
                                if ("E" === e[0] && "E" === e[1] ? (t = {
                                    ...
                                    let r = e.slice(0, 2);
                                    if ("+!" === r ? (t.signDisplay = "always", e = e.slice(2)) : "+?" === r && (t.signDisplay = "exceptZero", e = e.slice(2)), !T.test(e)) throw Error("Malformed concise eng/scientific notation");
        ...
        tryParsePluralOrSelectOptions(e, t, r, i) {
            ...
            for (;;) {
                if (0 === h.length) {
                    ...
                    if ("select" !== t && this.bumpIf("=")) {
                        ...
                        if (t.err) return t;
                        a = O(e, this.clonePosition()), h = this.message.slice(e.offset, this.offset())
                    } else break
                }
                if (o.has(h)) return this.error("select" === t ? 21 : 20, a);
                "other" === h && (s = !0), this.bumpSpace();
                let i = this.clonePosition();
                if (!this.bumpIf("{")) return this.error("select" === t ? 17 : 18, O(this.clonePosition(), this.clonePosition()));
            ...
            return 0 === n.length ? this.error("select" === t ? 15 : 16, O(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !s ? this.error(22, O(this.clonePosition(), this.clonePosition())) : {
                val: n,
                err: null
            }
        }
        tryParseDecimalInteger(e, t) {
            ...
            for (; !this.isEOF();) {
                let e = this.char();
                if (e >= 48 && e <= 57) s = !0, n = 10 * n + (e - 48), this.bump();
                else break
            }
            let o = O(i, this.clonePosition());
            return s ? Number.isSafeInteger(n *= r) ? {
                val: n,
                err: null
    ...
    function x(e, t = {}) {
        ...
        if (r.err) {
            let e = SyntaxError(N[r.err.kind]);
        ...
        return t ?.captureLocation || function e(t) {
            t.forEach(t => {
                ...
                else 2 === t.type && _(t.style) || (3 === t.type || 4 === t.type) && P(t.style) ? delete t.style.location : 8 === t.type && e(t.children)
            })
        }(r.val), r.val
    }
    ...
    var W = class e {
        constructor(t, r = e.defaultLocale, i, n) {
            if (this.formatterCache = {
                ...
                }, this.formatToParts = e => (function e(t, r, i, s, n, o, h) {
                    ...
                    for (let l of t) {
                        ...
                        if (3 === l.type) {
                            let e = "string" == typeof l.style ? s.date[l.style] : P(l.style) ? l.style.parsedOptions : void 0;
                            a.push({
                                type: 0,
                        ...
                        if (4 === l.type) {
                            let e = "string" == typeof l.style ? s.time[l.style] : P(l.style) ? l.style.parsedOptions : s.time.medium;
                            a.push({
                                type: 0,
                                value: i.getDateTimeFormat(r, e).format(u)
                            });
                        ...
                        if (2 === l.type) {
                            let e = "string" == typeof l.style ? s.number[l.style] : _(l.style) ? l.style.parsedOptions : void 0;
                            if (e && e.scale) {
                                let t = e.scale || 1;
                                if ("bigint" == typeof u) {
                        ...
                        if (8 === l.type) {
                            ...
                            let m = c(e(t, r, i, s, n, o).map(e => e.value));
                            Array.isArray(m) || (m = [m]), a.push(...m.map(e => ({
...
`, "MISSING_INTL_API", h);
                            ...
                            a.push(...e(o.value, r, i, s, n, c - (l.offset || 0)));
                            continue
                        }
                    }
            ...
            }(e.formats, i), this.formatters = n && n.formatters || function(e = {
                number: {},
                dateTime: {},
                pluralRules: {}
            }) {
    ...
    function z(...[e, t, r, s]) {
        let n;
        if (Array.isArray(t)) throw new c(m.INVALID_MESSAGE, void 0);
        if ("object" == typeof t) throw new c(m.INSUFFICIENT_PATH, void 0);
        if ("string" == typeof t) {
        ...
        a.getMessageFormat || (a.getMessageFormat = p((...e) => new W(e[0], e[1], e[2], {
            formatters: a,
            ...e[3]
        }), o.message));
        try {
            let e, r, i, s;
            n = a.getMessageFormat(t, u, (e = W.formats.date, r = W.formats.time, i = { ...l ?.dateTime,
                ...h ?.dateTime
            }, s = {
                date: { ...e,
                    ...i
                ...
                formatters: { ...a,
                    getDateTimeFormat: (e, t) => a.getDateTimeFormat(e, { ...t,
                        timeZone: t ?.timeZone ?? f
                    })
                }
            })
        } catch (e) {
            throw new c(m.INVALID_MESSAGE, void 0)
        }
        let g = n.format(r);
        return (0, i.isValidElement)(g) || Array.isArray(g) || "string" == typeof g ? g : String(g)
    }
    ...
    function ee(e, t, r, i) {
        ...
        return r.split(".").forEach(t => {
            let r = n[t];
            if (null == t || null == r) throw Error(s + ` (${e})`);
            n = r
        }), n
    }
    z.raw = !0;
    ...
    var er = e.i(82513);
    let ei = (0, i.createContext)(void 0);
    ...
    e.s(["IntlProvider", 0, function({
        ...
        let l = (0, i.useContext)(ei),
            u = (0, i.useMemo)(() => l ?.cache || f(), [s, l ?.cache]),
            c = (0, i.useMemo)(() => l ?.formatters || E(u), [u, l ?.formatters]),
            m = (0, i.useMemo)(() => ({ ... function({
                    ...
                    messages: void 0 === n ? l ?.messages : n,
                    now: o || l ?.now,
                    onError: h || l ?.onError,
        ...
        return (0, er.jsx)(ei.Provider, {
            value: m,
            children: e
        })
    }, "useFormatter", 0, function() {
        let {
            formats: e,
            formatters: t,
            locale: r,
        ...
        return (0, i.useMemo)(() => (function(e) {
            ...
            function h(e) {
                return e ?.timeZone || (o ? e = { ...e,
                    timeZone: o
                } : n(new c(m.ENVIRONMENT_FALLBACK, void 0))), e
            }
            ...
            function a(e, t, r, i, s) {
                ...
                try {
                    o = function(e, t, r) {
                        ...
                        if ("string" == typeof t) {
                            if (!(i = e ?.[t])) {
                                let e = new c(m.MISSING_FORMAT, void 0);
                                throw n(e), e
                            }
                        } else i = t;
                        return r && (i = { ...i,
                ...
                try {
                    ...
                    return n(new c(m.FORMATTING_ERROR, e.message)), s()
                }
            }

            function l(e, t, n) {
                return a(t, n, i ?.dateTime, t => (t = h(t), r.getDateTimeFormat(s, t).format(e)), () => String(e))
            }

            function u() {
                return e.now ? e.now : (n(new c(m.ENVIRONMENT_FALLBACK, void 0)), new Date)
            }
            return {
                dateTime: l,
                number: function(e, t, n) {
                    return a(t, n, i ?.number, t => r.getNumberFormat(s, t).format(e), () => String(e))
                },
                relativeTime: function(e, t) {
                    try {
                        var i;
                        let n, o, h, a = {};
                        t instanceof Date || "number" == typeof t ? n = new Date(t) : t && (n = null != t.now ? new Date(t.now) : u(), o = t.unit, a.style = t.style, a.numberingSystem = t.numberingSystem), n || (n = u());
                        let l = (new Date(e).getTime() - n.getTime()) / 1e3;
                        o || (o = (h = Math.abs(l)) < 60 ? "second" : h < 3600 ? "minute" : h < 86400 ? "hour" : h < 604800 ? "day" : h < 2628e3 ? "week" : h < 31536e3 ? "month" : "year"), a.numeric = "second" === o ? "auto" : "always";
                        let c = (i = o, Math.round(l / et[i]));
                        return r.getRelativeTimeFormat(s, a).format(c, o)
                    } catch (t) {
                        return n(new c(m.FORMATTING_ERROR, t.message)), String(e)
                    }
                },
                list: function(e, t, n) {
                    let o = [],
                    ...
                    for (let t of e) {
                        let e;
                        "object" == typeof t ? (e = String(l), h.set(e, t)) : e = String(t), o.push(e), l++
                    }
                    return a(t, n, i ?.list, e => {
                        let t = r.getListFormat(s, e).formatToParts(o).map(e => "literal" === e.type ? e.value : h.get(e.value) || e.value);
                        return h.size > 0 ? t : t.join("")
                    }, () => String(e))
                },
                dateTimeRange: function(e, t, n, o) {
                    return a(n, o, i ?.dateTime, i => (i = h(i), r.getDateTimeFormat(s, i).formatRange(e, t)), () => [l(e), l(t)].join(" – "))
                },
                displayName: function(e, t, n) {
                    return a(t, n, i ?.displayName, t => r.getDisplayNames(s, t).of(e), () => e)
                }
            }
        })({
            formats: e,
        ...
        return function(e, t) {
            let {
                ...
                onError: a,
                timeZone: l
            } = es(), u = e["!"], f = "!" === t ? void 0 : t.slice(2);
            return l || en || !eo || (en = !0, a(new c(m.ENVIRONMENT_FALLBACK, void 0))), (0, i.useMemo)(() => {
                var e;
                let t;
                return t = function(e, t, r) {
                        try {
                            ...
                            return new c(m.MISSING_MESSAGE, e.message)
                        }
                    }((e = {
                        cache: r,
                        formatters: n,
                        ...
                        locale: h,
                        timeZone: l
                    }).locale, e.messages, e.namespace),
                    function({
                        cache: e,
                        formats: t,
                        formatters: r,
                        getMessageFallback: s = J,
                        locale: n,
                        messagesOrError: o,
                        namespace: h,
                        onError: a,
                        ...
                        function p(p, g, E, b) {
                            ...
                            if (u) {
                                ...
                                if (!b) return f(p, m.MISSING_MESSAGE, e.message, b);
                                H = b
                            }
                            try {
                                let s, o = q(h, p);
                                return z(o, H, g ? (s = {}, Object.keys(g).forEach(e => {
                                    let t, r = 0,
                                        n = g[e];
                                    t = "function" == typeof n ? t => {
                                        let s = n(t);
                                        return (0, i.isValidElement)(s) ? (0, i.cloneElement)(s, {
                                            key: e + r++
                                        }) : s
                                    } : n, s[e] = t
                                }), s) : g, {
                                ...
                                let e, t;
                                return r instanceof c ? (e = r.code, t = r.originalMessage) : (e = m.FORMATTING_ERROR, t = r.message), f(p, e, t, b)
                            }
                        }

                        function g(e, t, r, i) {
                            let s = p(e, t, r, i);
                            return "string" != typeof s ? f(e, m.INVALID_MESSAGE, void 0) : s
                        }
                        return g.rich = p, g.markup = (e, t, r, i) => p(e, t, r, i), g.raw = e => {
                            if (u) return a(o), s({
                                error: o,
                                key: e,
                                namespace: h
